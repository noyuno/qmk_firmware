...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT( /* Base */ 
    KC_S,    KC_V,    KC_L,    KC_C,  XXXXXXX,  XXXXXXX,  
    KC_B,    KC_E,    KC_SPACE,    KC_X,     XXXXXXX,   XXXXXXX,  
    SCMD(KC_Z), XXXXXXX, LCMD(KC_Z),    KC_V,   XXXXXXX,  XXXXXXX,  
    KC_P0,    XXXXXXX,  KC_PDOT,  KC_UP,    KC_PGDN,  XXXXXXX,  
    KC_C,    XXXXXXX, XXXXXXX,    KC_4,     XXXXXXX,   XXXXXXX,
